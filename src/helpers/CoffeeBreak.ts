...
export default class CoffeeBreak {
    private coffeeBreak: CoffeeBreakMapper;
    ...
    async load() {
        ...
        this.coffeeBreak = CoffeeBreakMapper.parse(api.lastResponse.data as string);
    }
    ...
    filterGamesByTitle(value: string) {
        return lodash.find(this.getData.games, {title: value});
    }
}
